...
const [openAlert, setOpenAlert]=useState(false)
	...
	return (
		...
		<Link to={"/dashboard/resume/" + resume.documentId + "/edit"}>
			<div className='p-14 bg-gradient-to-b from-pink-100 via-purple-200 to-blue-200 flex 
			items-center justify-center h-[280px] rounded-lg border-t-4 hover:scale-105 transition-all 
		...
		<div className="flex justify-between p-3 border text-white"
		style={{
